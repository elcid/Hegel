...
const transData = {
  ...
  crossRefTexts: {
    ...
    "s03_b01": { en: "As Becoming is the genesis of Determinate Being, so is Interaction the genesis of the Concept.", es: "Como el Devenir es la génesis del Ser Determinado, así es la Acción Recíproca la génesis del Concepto." },
    ...
    "s04_w01": { en: "Determinate Being falls back into the sphere of Essence when essential and unessential are distinguished.", es: "El Ser Determinado cae de nuevo en la esfera de la Esencia cuando esencial y no-esencial son distinguidos." },
    "s05_s10": { en: "Quantity is the *sublated* Quality — which against Being has become indifferent determinateness.", es: "La Cantidad es la Cualidad *superada* — que frente al Ser se ha convertido en determinación indiferente." },
    ...
    "s08_s05": { en: "Being-for-self is the result of the dialectic of Something and Other, finitude and infinity.", es: "El Ser-para-sí es el resultado de la dialéctica de Algo y Otro, finitud e infinitud." },
    "s08_s09": { en: "Being-for-self as One posits the Many, and in Attraction the Many return to the One.", es: "El Ser-para-sí como Uno pone los Muchos, y en la Atracción los Muchos retornan al Uno." },
    ...
    "s10_w01": { en: "Quantity in the sphere of Being corresponds to what Essence as a whole is: absolute indifference toward the limit.", es: "La Cantidad en la esfera del Ser corresponde a lo que la Esencia en su conjunto es: indiferencia absoluta frente al límite." },
    ...
    "s12_w01": { en: "The measureless and the reversal of measures lead to the *Becoming of Essence* — over absolute indifference.", es: "Lo desmedido y la inversión de las medidas conducen al *Devenir de la Esencia* — sobre la indiferencia absoluta." },
    ...
    "s13_s03": { en: "As Becoming from the contradiction of Being and Nothing, so Essence emerges from the dissolution of measure in absolute indifference.", es: "Como el Devenir de la contradicción del Ser y la Nada, así la Esencia surge de la disolución de la medida en la indiferencia absoluta." },
    "s13_w11": { en: "Absolute Indifference resembles Spinozistic substance, but remains in the sphere of Being and does not yet reach Essence.", es: "La Indiferencia Absoluta se asemeja a la substancia spinozista, pero permanece en la esfera del Ser y no alcanza aún la Esencia." },
    ...
    "w01_b01": { en: "Essence passes through reflection into the Concept. The Concept is the truth of Essence (as of Being).", es: "La Esencia pasa a través de la reflexión al Concepto. El Concepto es la verdad de la Esencia (como del Ser)." },
    ...
    "w03_b01": { en: "Reflection is the movement proper to Essence; the Concept, by contrast, is the movement of self-developing self-consciousness.", es: "La Reflexión es el movimiento propio de la Esencia; el Concepto, por contraste, es el movimiento de la autoconciencia que se desarrolla a sí misma." },
    ...
    "w09_w13": { en: "Actuality in its highest form (Interaction) is the genesis of the Concept.", es: "La Realidad Efectiva en su forma más alta (Acción Recíproca) es la génesis del Concepto." },
    ...
    "w11_w13": { en: "The dialectical movement of Substance through Causality and Interaction is the genesis of the Concept. The Concept is the *truth* of Substance.", es: "El movimiento dialéctico de la Substancia a través de la Causalidad y la Acción Recíproca es la génesis del Concepto. El Concepto es la *verdad* de la Substancia." },
    ...
    "b07_w09": { en: "The Idea is the *true* actuality — as opposed to the merely essential actuality.", es: "La Idea es la *verdadera* realidad — frente a la meramente realidad esencial." },
    "b08_b07": { en: "First, immediate shape of the Idea.", es: "Primera figura inmediata de la Idea." },
    "b08_b09": { en: "Life dies and passes over into Cognition — spirit elevates itself above life.", es: "La Vida muere y pasa al Conocer — el espíritu se eleva sobre la vida." },
    ...
    "b10_s01": { en: "The Absolute Idea returns to Being — but as comprehended Being (the transition to the philosophy of nature).", es: "La Idea Absoluta retorna al Ser — pero como Ser comprendido (la transición a la filosofía de la naturaleza)." },
    "b10_b10": { en: "They are sublated moments of the Absolute Idea.", es: "Son momentos superados de la Idea Absoluta." },
    "b10_b10m": { en: "The Method is the consciousness of the form of the inner self-movement of its content.", es: "El Método es la conciencia de la forma del automovimiento interno de su contenido." }
  }
};
